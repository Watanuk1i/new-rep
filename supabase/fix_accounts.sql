...
-- Удалит ВСЕХ участников (и связанные pari/debts/notifications через CASCADE)
...
-- 4) Сбрасываем PostgREST-кэш схемы (убирает ошибку "Could not find table in schema cache")
